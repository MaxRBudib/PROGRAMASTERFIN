...
export default function Home() {
  ...
  const onSubmit = handleSubmit((values) => {
    ...
    axios.get('http://127.0.0.1:8000/my_view/ejercicios/').then((response) => {
    ...
    axios.post('http://127.0.0.1:8000/my_view/tarea/', intento, config).then((response) => {
      ...
      for (let i = 0; i < copyFilter.length; i++) {
        ...
        axios.post('http://127.0.0.1:8000/my_view/ejercicioTarea/', pruebaPost, config)
      ...
      axios.get('http://127.0.0.1:8000/my_view/usuarioGrupo/', {
        ...
        const requests = alumnos.flatMap((matricula_nomina) => {
          return copyFilter.map((filter) => {
            ...
            return axios.post('http://127.0.0.1:8000/my_view/usuarioEjercicioTarea/', task, config);
          });
        });
