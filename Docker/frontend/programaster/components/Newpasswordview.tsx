          ...
          <form onSubmit={onSubmit} action="" className='relative space-y-3 min-h-full flex-col justify-center px-6 py-12 lg:px-8 md:mt-0 md:px-30'>
            ...
            <div className="space-y-2">
              <input {...register('contraseña',
                ...
                name="contraseña" className="border-2 border-slate-500 bg-gray-900 input py-2.5" type="text" placeholder="Ejem: A01111111@tec.mx"/>
              {errors.contraseña?.type == 'required' &&
                <div className="flex text-sm text-red-800 dark:text-red-400" role="alert">
                  ...
                  <div>
                    <span className="font-medium">Por favor inserte una nueva contraseña</span>
                  </div>
                </div>
              }
