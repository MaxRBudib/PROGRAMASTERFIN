...
<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mx-auto z-0 px-6 md:px-12 xl:px-32 w-full">
    <div className="text-center text-gray-800">
      <div className="block rounded-lg shadow-lg px-6 py-20 md:py-16 md:px-12 mt-180 bg-white bg-opacity-80 backdrop-filter backdrop-saturate-200 backdrop-blur-25">
        <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">PrograMaster<br /><span className="text-blue-600">Learn Coding</span></h1>
        <a href="/auth/signup" className="inline-block px-7 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" role="button">Empieza Ahora</a>
        <a href="/auth/login" className="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" role="button">Inicia Sesión</a>
      </div>
    </div>
  </div>
  ...
  <section className="">
    ...
    <svg style={{zIndex:"-1", position:"fixed", backgroundSize:"contain"}} xmlns="http://www.w3.org/2000/svg" className="bg block w-full margin-auto z-0" height="680" preserveAspectRatio="none" viewBox="0 0 1920 880">

      <g transform="pl-6 translate(960,440) scale(1,1) translate(-1000,-440)">
        <linearGradient
